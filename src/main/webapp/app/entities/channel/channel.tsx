          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jiveApp.channel.member">Member</Translate>
                </th>
                <th>
                  <Translate contentKey="jiveApp.channel.message">Message</Translate>
                </th>
                <th />
              </tr>
            </thead>
                  ...
                  <td>
                    {channel.members
                      ? channel.members.map((val, j) => (
                          <span key={j}>
                            <Link to={`/member/${val.id}`}>{val.id}</Link>
                            {j === channel.members.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
                  <td>{channel.message ? <Link to={`/message/${channel.message.id}`}>{channel.message.id}</Link> : ''}</td>
