            ...
            <tbody>
              {directMessageList.map((directMessage, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{directMessage.userId1}</td>
                  <td>{directMessage.userId2}</td>
                  <td>
                    {directMessage.userProfiles
                      ? directMessage.userProfiles.map((val, j) => (
                          <span key={j}>
                            <Link to={`/user-profile/${val.id}`}>{val.id}</Link>
                            {j === directMessage.userProfiles.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
