...
class DirectMessageResourceIT {
    ...
    public static DirectMessage createEntity(EntityManager em) {
        DirectMessage directMessage = new DirectMessage().userId1(DEFAULT_USER_ID_1).userId2(DEFAULT_USER_ID_2);
    ...
    public static DirectMessage createUpdatedEntity(EntityManager em) {
        DirectMessage directMessage = new DirectMessage().userId1(UPDATED_USER_ID_1).userId2(UPDATED_USER_ID_2);
        return directMessage;
    }
    ...
    void createDirectMessage() throws Exception {
        ...
        assertThat(testDirectMessage.getUserId1()).isEqualTo(DEFAULT_USER_ID_1);
        assertThat(testDirectMessage.getUserId2()).isEqualTo(DEFAULT_USER_ID_2);
    }
    ...
    void putExistingDirectMessage() throws Exception {
        ...
        updatedDirectMessage.userId1(UPDATED_USER_ID_1).userId2(UPDATED_USER_ID_2);
        ...
        DirectMessage testDirectMessage = directMessageList.get(directMessageList.size() - 1);
        assertThat(testDirectMessage.getUserId1()).isEqualTo(UPDATED_USER_ID_1);
        assertThat(testDirectMessage.getUserId2()).isEqualTo(UPDATED_USER_ID_2);
    }
    ...
    void fullUpdateDirectMessageWithPatch() throws Exception {
        ...
        partialUpdatedDirectMessage.userId1(UPDATED_USER_ID_1).userId2(UPDATED_USER_ID_2);
