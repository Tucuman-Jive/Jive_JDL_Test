...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().userId(DEFAULT_USER_ID).channelID(DEFAULT_CHANNEL_ID).text(DEFAULT_TEXT);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().userId(UPDATED_USER_ID).channelID(UPDATED_CHANNEL_ID).text(UPDATED_TEXT);
        return message;
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.userId(UPDATED_USER_ID).channelID(UPDATED_CHANNEL_ID).text(UPDATED_TEXT);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.userId(UPDATED_USER_ID).channelID(UPDATED_CHANNEL_ID).text(UPDATED_TEXT);
